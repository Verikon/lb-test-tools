...
if (!process.argv.slice(2).length) {
	...
	const examples = ['Examples:', '', '% lbtt default database -- set the default database through the CLI', '% lbtt default database mydb -- set mydb to be the default database', '', ''];
